...
VAEmodel.load_state_dict(torch.load('SSTmodel/all_3_VAE.bin'))
...
for it in range(100000):
    ...
    if it%200==0:
        ...
        if sample_sent:
            ...
            f0 = predict_sentiment(sample_sent,Jewelrymodel,JewelryTEXT)
    ...
    if it%1000==0:
        print("saving model all_3_VAE.bin")
        print("\n")
        torch.save(VAEmodel.state_dict(), 'SSTmodel/{}.bin'.format('all_3_VAE')) 
