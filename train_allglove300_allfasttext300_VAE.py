...
Beautymodel.load_state_dict(torch.load('SSTmodel/SSTtrainall_fasttext300.bin'))
...
for it in range(100000):
    ...
    if it%1000==0:
        print("saving model allglove300_allfasttext300_VAE.bin")
        print("\n")
        torch.save(VAEmodel.state_dict(), 'SSTmodel/{}.bin'.format('allglove300_allfasttext300_VAE')) 
